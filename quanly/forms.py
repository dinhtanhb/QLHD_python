...
class NhatKyThucHienForm(BootstrapModelForm):
    class Meta:
        ...
        fields = ["phan_cong", "ngay_thuc_hien", "gio_bat_dau", "gio_ket_thuc", "ky_can_thiep", "so_buoi_thuc_hien", "so_luot_di_lai", "ghi_chu"]
        widgets = {
...
class NhatKyCanThiepForm(BootstrapModelForm):
    ...
    class Meta:
        model = NhatKyThucHien
        fields = ["hop_dong", "phan_cong", "ngay_thuc_hien", "gio_bat_dau", "gio_ket_thuc", "ky_can_thiep", "so_buoi_thuc_hien", "so_luot_di_lai", "ghi_chu"]
        widgets = {
